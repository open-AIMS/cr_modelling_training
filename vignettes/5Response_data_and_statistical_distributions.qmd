...
module 2 and set out in module 4, makes the same comparison within concentration
groups. On a model set it reports every equation separately.
...
transformation has not removed that change. *Dispersion that changes across the
curve* below takes the same data on the beta scale and measures what the `disp`
term does about it.
