...
#| fig-align: center
#| echo: false
#| fig-cap: "A threshold curve and a smooth curve fitted to the same response range. The threshold curve is flat until the break and then falls steeply; the smooth curve is already declining at the lowest concentrations. Reproduced from @fisherfox2023 under CC BY-NC 4.0."
...
#| fig-align: center
#| echo: false
#| fig-cap: "Toxicity estimates used for no and low effects in species sensitivity distribution modelling. Reproduced from @fisheretal2023 under CC BY 4.0."
