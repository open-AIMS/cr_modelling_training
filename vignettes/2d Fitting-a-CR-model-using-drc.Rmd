...
plot(model_LL4)
abline(v=nsec(model_LL4, x_var = "x"), lty=c(1,3,3))
```
...
We added the estimated *NSEC* value that would be equivalent to the Bayesnec version, more on this in a later module.
...
plot(daphnids.m1)
#abline(v=nsec(daphnids.m1, x_var = "dose"), lty=c(1,3,3))
```
