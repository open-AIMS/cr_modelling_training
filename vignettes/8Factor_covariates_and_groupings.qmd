...
model: one deviation on five batches covers three quarters of the distance
between `ogl(plate)` and the best fit of the four.
...
part of it the plates are least likely to share. That, rather than the
positional shift, is what the remaining 72.6 of predictive density is bought
with.
...
0.073, 0.084 and 0.095, and its lower bound rises from 0.009 to between 0.040
...
equation. The price is the one *The number of levels a deviation needs* gives:
four standard deviations estimated from sixteen levels here, where `ogl()`
estimates one.
