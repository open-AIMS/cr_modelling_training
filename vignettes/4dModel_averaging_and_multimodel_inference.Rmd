...
ametryn_LL3 <-  drm(fvfm~concentration, data=ametryn_data, fct=LL.3(names = c("Slope","Upper Limit", "Midpoint")))
...
mselect(ametryn_LL3, fctList = list(W1.3(),W2.3(), LN.3(), NEC.3(),W1.4(),W2.4(), LN.4(), NEC.4()), linreg=T)
...
ametryn_W23 <-  drm(fvfm~concentration, data=ametryn_data, fct=W2.3(names = c("Slope","Upper Limit", "Midpoint")))
