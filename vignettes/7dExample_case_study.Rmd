...
```
The model appears to fit the data well. Let's Check the NEC (the 'e' parameter). We can 4 use `confint` function to calculate confidence intervals for the parameter. 
...
maED(ametryn_LL3, 
    ...
    interval="kang")
```
Nearly all the weight is coming from the 4-parameter log-logistic model. Dr Rebecca Fisher has developed a function to calculate the NSEC from drc models. 
